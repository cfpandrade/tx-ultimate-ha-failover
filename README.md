...
packages:
  remote_package:
    ...
    ref: v1.5.0  # Recommended: pin to a release tag
...
wifi:
  ...
  use_address: 192.168.1.50  # Optional: your device IP
  ap:
    ssid: "Tx-Living"
...
- Prefer release tags like `v1.5.0` instead of `main` for predictable builds.
